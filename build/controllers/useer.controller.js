...
var UserController = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.connector.table('users')
                                .select('*')];
                    case 1:
                        data = _a.sent();
                        res.send(data);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.connector.table('users').whereIn('id', id)];
                    case 2:
                        data = _a.sent();
                        res.send(data);
                        return [3 /*break*/, 4];
    ...
    UserController.prototype.updateUserInfo = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, data, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.connector.table('users').whereIn('id', id).update(req.body).returning('*')];
                    case 2:
                        data = _a.sent();
                        res.send(data);
                        return [3 /*break*/, 4];
